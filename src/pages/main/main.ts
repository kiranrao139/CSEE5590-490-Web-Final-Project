...
export class MainPage {
  ...
  ionViewDidLoad(){
    ...
    this.geo.getCurrentPosition().then( pos => {
      ...
      this.httpClient.get('https://api.foursquare.com/v2/venues/search?client_id=0NIAZHYXT3VDLURYAGEN0CBQUM0D052TP5LZGBNTX3PO0VRR&client_secret=UKSMFU4YESVMOJI3H4XDIIRL4SLAJXYDQRDC5NWHNNJFWCQQ&v=20180223&limit=5&ll='+ this.lat+','+this.lng+'&query=pharmacy').subscribe((data:any) => {
